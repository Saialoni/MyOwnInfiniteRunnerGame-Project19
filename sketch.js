...
ground_image=loadImage("images/Background.png");
  girl_running=loadAnimation("images/Run (1).png","images/Run (2).png","images/Run (3).png","images/Run (4).png","images/Run (5).png","images/Run (6).png","images/Run (7).png","images/Run (8).png","images/Run (9).png","images/Run (10).png","images/Run (11).png","images/Run (12).png","images/Run (14).png","images/Run (15).png","images/Run (16).png","images/Run (17).png","images/Run (18).png","images/Run (19).png","images/Run (20).png");
